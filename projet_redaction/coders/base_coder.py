...
class Coder:
            ...
            if map_tokens > 0:
                ...
                if map_tokens > max_map_tokens:
                    lines.append(
                        ...
                        " irrelevant text can confuse GPT."
                    )
            else:
            ...
            if self.gpt_prompts.example_messages:
                example_messages += [
                    dict(
                        role="user",
                        content=(
                            "I switched to a new text base. Please don't consider the above files"
    ...
    def show_exhausted_error(self):
        ...
        if output_tokens >= max_output_tokens:
            ...
            res.append("- Break your text into smaller source files.")
