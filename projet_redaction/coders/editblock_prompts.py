...
Respect and use existing conventions, libraries, etc that are already present in the text base.
{lazy_prompt}
...
- If your text changes add new dependencies, suggest the command to install them.
- Etc.
"""
